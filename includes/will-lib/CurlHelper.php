...
class CurlHelperException extends GoKabamLibException {
...
class CurlHelper {
	...
	public function get_debug_log(): ?string
    { return  $this->log;}
	/**
	 ...
	 * @throws CurlHelperException
	 */
	public static function  write_to_file($root_name,$extension,$contents): string
    {
...
// data fields for POST request
	...
	protected function build_data_files($boundary, $fields, $files): string
    {
		$data = '';
		$eol = "\r\n";
	...
	function get_cookie_file_path(): ?string
